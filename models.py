...
class LeNet5(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 6, 5, padding=0)  # 24 24 -->12 12
        self.conv2 = nn.Conv2d(6, 16, 5, padding=0)  # 8 8 -->4 4
...
class Model_on_cifar10_170(nn.Module):
    ...
    def forward(self, x):
        x = F.max_pool2d(F.batch_norm(F.relu(self.conv1(x)), kernel_size=(2, 2)))
        x = F.max_pool2d(F.relu(self.conv2(x)), kernel_size=(2, 2))
